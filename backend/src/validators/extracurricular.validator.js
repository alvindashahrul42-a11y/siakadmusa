/**
 * Validator untuk Extracurricular
 */

/**
 * Validate extracurricular data
 * @param {Object} data - Extracurricular data
 * @param {boolean} isUpdate - Whether this is an update (makes fields optional)
 * @returns {{ isValid: boolean, errors: string[] }}
 */
const validateExtracurricular = (data, isUpdate = false) => {
  const errors = [];
...
module.exports = { validateExtracurricular };
